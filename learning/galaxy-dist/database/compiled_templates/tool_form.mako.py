...
_magic_number = 6
_modified_time = 1350185350.2248559
...
def _mako_generate_namespaces(context):
    # SOURCE LINE 2
    ns = runtime.TemplateNamespace('__anon_0x8f3de10', context._clean_inheritance_tokens(), templateuri=u'/message.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x8f3de10')] = ns

    # SOURCE LINE 3
    ns = runtime.TemplateNamespace('__anon_0x8f3dd90', context._clean_inheritance_tokens(), templateuri=u'/base_panels.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x8f3dd90')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x8f3de10')._populate(_import_ns, [u'render_msg'])
        _mako_get_namespace(context, '__anon_0x8f3dd90')._populate(_import_ns, [u'overlay'])
    ...
    # Name of the tool in lower case
        ...
        if tool.has_multiple_pages:
            ...
            pass
        # SOURCE LINE 304
        __M_writer(u'        <!-- BioStar links -->\n        <a href="http://slyfox.bx.psu.edu:8080/new/post/tagged/')
        # SOURCE LINE 305
        __M_writer(unicode(low_tool_name))
        __M_writer(u'" target="galaxy_main" class="icon-button general-question tooltip close-side-panels" data-original-title="Ask a tool related question"></a>\n        <a href="http://slyfox.bx.psu.edu:8080/show/tag/')
        # SOURCE LINE 306
        __M_writer(unicode(low_tool_name))
        __M_writer(u'/" target="galaxy_main" class="icon-button tag-question tooltip close-side-panels" data-original-title="See tool related posts" ></a>\n        <!-- End of BioStar links -->\n        </div>\n        <div class="toolFormBody">\n            <input type="hidden" name="refresh" value="refresh">\n            <input type="hidden" name="tool_id" value="')
        # SOURCE LINE 311
        __M_writer(unicode(tool.id))
...
def render_javascripts(context):
    ...
    try:
        ...
        __M_writer(u'\n    ')
        # SOURCE LINE 16
        __M_writer(unicode(h.js( "galaxy.panels", "libs/jquery/jquery.autocomplete", "libs/jquery/jstorage" )))
